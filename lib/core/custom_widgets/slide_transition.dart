...
/// [fadeDuration] : duration of animation of Fade (default: Duration(milliseconds: 500))
...
/// [alignment] : alignment of the Fade animation (default: [Alignment.center])
...
class _FadedSlideAnimationState extends State<FadedSlideAnimation> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animation = CurvedAnimation(parent: _FadeController, curve: widget.FadeCurve);
    _FadeController.forward();
    _slideController = AnimationController(
      duration: widget.slideDuration,
      vsync: this,
    );
    _offsetAnimation = Tween<Offset>(begin: widget.beginOffset, end: widget.endOffset).animate(
