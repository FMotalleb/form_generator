...
class _ScaledSlideAnimationState extends State<ScaledSlideAnimation> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animation = CurvedAnimation(parent: _scaleController, curve: widget.scaleCurve);
